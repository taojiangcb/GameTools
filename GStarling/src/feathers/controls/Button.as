...
package feathers.controls
{
	...
	public class Button extends FeathersControl implements IToggle, IFocusDisplayObject
	{
		...
		protected var beginx:Number;
		protected var beginy:Number;
		/**
		 * @private
		 */
...
//				const isInBounds:Boolean = this.contains(this.stage.hitTest(HELPER_POINT, true));
				...
				//优化button在iphone4小屏幕点击
				const isInBounds:Boolean = !(touch.globalX < beginx - 30 ||touch.globalY < beginy - 30 ||touch.globalX > beginx + 30 ||touch.globalY > beginy + 30)
			...
			else //if we get here, we don't have a saved touch ID yet
			{
				...
				if(touch)
				{
					...
					this.beginx = touch.globalX;
					this.beginy = touch.globalY;
