...
package com.uiComponent.TLFTextSprite.text.tlf {
	...
	import com.uiComponent.TLFTextSprite.events.TLFFlowEvent;
...
import com.uiComponent.TLFTextSprite.events.TLFFlowEvent;
import com.uiComponent.TLFTextSprite.text.tlf.TLFControlSprite;
...
//	/**使能超链接*/
//	public function linkClickEnable($enable:Boolean=false):LoadLayout{
//		_dicTemp[getDicTempLink(_url)] = $enable;
//		return _loadLayout;
//	}
	/**设置加载类型:xml或html*/
