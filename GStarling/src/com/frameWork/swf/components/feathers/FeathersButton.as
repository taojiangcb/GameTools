package com.frameWork.swf.components.feathers
{
	...
	public class FeathersButton extends Button implements ISwfComponent
	{
		public function initialization(componetContent:SwfSprite):void
		{
			...
			var _selectUpSkin:DisplayObject = componetContent.getSkinByName("_selectUpSkin");
			var _downSkin:DisplayObject = componetContent.getSkinByName("_downSkin");
			var _disabledSkin:DisplayObject = componetContent.getSkinByName("_disabledSkin");
			var _selectDisabledSkin:DisplayObject = componetContent.getSkinByName("_selectDisabledSkin");
