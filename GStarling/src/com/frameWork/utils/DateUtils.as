package com.frameWork.utils
{
	...
	public class DateUtils
	{
		...
		public static const DAY:uint 							= 864000;
		...
		public static function TimeStampFormat(timeStamp:uint):String
		{
			...
			var str:String = formatString("{0}{1}{2}:{3}",
		...
		public static function TimeStampExpFormat(timeStamp:uint):String
		{
			...
			var str:String = formatString("{0}{1}{2}{3}",
				day>0?formatString("{0}天",day):"",
				hour>0?formatString("{0}小时",hour):"",
				hour>0?"":formatString("{0}分",minute),
				hour>0?"":formatString("{0}秒",second)
			);
			return str;
		}
        ...
        public static function DateFormat(date:Date,format:String="YYYY-MM-DD"):String
        {
			...
			dateFormat.setDateTimePattern(format);
		...
		public static function GetTimeByTimeInterval(time:Number):String
		{
			...
			var str:String = formatString("{0}{1}{2}",
				day > 0 ? formatString("{0}天",day) : "",
				hour > 0 ? formatString("{0}小时",hour) : "",
				formatString("{0}分",minute));
